...
//               F:/ShootingStar/vhdl_code/BOARD_DESIGN/ip/BOARD_DESIGN_COMMAND_PROCESSOR_0_1/BOARD_DESIGN_COMMAND_PROCESSOR_0_1_stub.v
...
module BOARD_DESIGN_COMMAND_PROCESSOR_0_1(clk, mc_data, mc_clk, mc_register_select, 
  ...
  OAMEnable, start_music, reset_APU, start_addres_APU)
/* synthesis syn_black_box black_box_pad_pin="clk,mc_data[7:0],mc_clk,mc_register_select,x_loc_sprite[8:0],y_loc_sprite[8:0],sprite_memory_loc[7:0],sprite_attribute[7:0],sprite_register_loc[6:0],OAMEnable,start_music,reset_APU,start_addres_APU[10:0]" */;
  input clk;
  input [7:0]mc_data;
  input mc_clk;
